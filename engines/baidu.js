...
const search_url = `https://www.baidu.com/s?wd={key}&pn={page}=rn={pageSize}`

const results_xpath  = `.//div[@class="c-container"]`
const title_xpath = `.//h3[@class='c-title']/a`
const href_xpath = `.//h3[@class='c-title']/a/@href`
const content_xpath = `.//div[starts-with(@class, 'content-right')]`
